			...
			<div class="modal">
				<div class="modal_content">
					...
					<div class="delete-content">
						<p>"다시 한번 생각해보세요!"</p>
						<p>${loginUser.username}님이 평가하신 영화, 드라마…. 이런 추억을 모두 버리실 건가요? ㅠ.ㅠ 영화를 보며 감동받았던 순간, 드라마를 보며 펑펑 울었던 순간…이런 순간들을 버리지 말아주세요.</p>
						<p>${loginUser.username}님, 왓챠피디아는 아주 빠른 속도로 업데이트되고 있어요. 영화, 드라마뿐만 아니라 이승재님을 위한 다양한 문화생활 도우미가 되기 위해 밤낮없이 고민하며 발전시키고 있답니다.</p>
						<p>용서하는 마음으로 이 메일을 살포시 무시해 주시고, 차분하게 왓챠피디아에서 추억을 기록해보세요. 나중에 살려두길 잘했다고 생각하실 거예요!</p>

...
<body class=".reviewDetail">
	...
	<div class="comment_modal">
		<div class="comment_modal_content">
			<div class="comment_modal_head">
				<span>댓글</span>
				<img class="x" src="${cp}/resources/images/x.svg" alt="x">				
			</div>
			<textarea id="comment_comment" maxlength="10000" placeholder="이 리뷰에 대한 댓글을 적어주세요."></textarea>
			<div class="comment_modal_footer">
				<div class="comment_modal_etc">
					<span class="comment_comment_len">0</span><span>/10000</span>
					<input class="comment_comment_btn" type='button' disabled="disabled" value='저장'/>						
				</div>
			</div>
		</div>
	</div>
